...
# Python unit test
SRC=$HOME/jaks.git/stitch.github/
FILES="LICENSE setup.py setup.flamer.cfg"
for f in $FILES; do
   # DRY-RUN '-n'
   echo "rsync file: " $f
   $RSYNC -va $SRC/$f $DEST ;
...
SRC=$HOME/jaks.git/stitch.github/integrated_test/weld/potts
