...
def main(prefix):
    ...
    # Below are z-cuts; by x or y cuts may also be done
    bx=[0,100]
    by=[0,100]
    bz=[24,25]  # visualize top of 1st layer
    bz=[49,50]  # visualize top of 2nd layer
    bz=[74,75]  # visualize top of 3rd layer
    bz=[99,100] # visualize top of 4th layer
    bb=bx+by+bz
