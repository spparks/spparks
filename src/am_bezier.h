...
public:
  ...
  AM_Bezier(const array<double, 5> &x, const array<double, 5> &y,
            const array<double, 5> &z, double beta1, double beta2, double width,
            double depth);
  void initialize();

  bool inside_outside(const array<double, 3> &xyz,
  ...
  closest_point_projection(const array<double, 3> &xyz) const;
...
private:
  ...
  on_spine_curve(const array<double, 3> &xyz) const;
  tuple<bool, array<double, 2>, double>
  on_top_curve(const array<double, 3> &xyz) const;
  tuple<array<double, 2>, double>
  _closest_point_projection(const array<double, 3> &xyz) const;
