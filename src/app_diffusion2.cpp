...
double AppDiffusion2::site_propensity_no_energy(int i)
{
...
int AppDiffusion2::neighbor2(int i, int *sites)
{
  int k,kk,m,mm,isite;
...
int AppDiffusion2::neighbor3(int i, int *sites)
{
...
int AppDiffusion2::neighbor4(int i, int *sites)
{
...
double AppDiffusion2::distsq_to_line(int m, double *start,
...
void AppDiffusion2::allocate_data()
{
