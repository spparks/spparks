...
void AppPotts3d6n::site_event_rejection(int i, int j, int k,
					RandomPark *random)
{
  ...
  //if (iran == 0) return lattice[i-1][j][k];
  //else if (iran == 1) return lattice[i+1][j][k];
  //else if (iran == 2) return lattice[i][j-1][k];
  //else if (iran == 3) return lattice[i][j+1][k];
  //else if (iran == 4) return lattice[i][j][k-1];
