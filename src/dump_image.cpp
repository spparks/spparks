  ...
  DumpText(spk, narg, arg)
{
  ...
  if (scolor == IATTRIBUTE) {
    ...
    for (int i = clo; i <= chi; i++) {
      int j = i-clo;
      if (i % 6 == 0) colorattribute[i] = color2rgb("red");
      else if (i % 6 == 1) colorattribute[i] = color2rgb("green");
      else if (i % 6 == 2) colorattribute[i] = color2rgb("blue");
      else if (i % 6 == 3) colorattribute[i] = color2rgb("yellow");
      else if (i % 6 == 4) colorattribute[i] = color2rgb("aqua");
      else if (i % 6 == 5) colorattribute[i] = color2rgb("cyan");
    }
  }
